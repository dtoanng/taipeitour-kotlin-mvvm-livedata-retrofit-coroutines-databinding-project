...
fun DependencyHandler.addDependencies() {
    ...
    implementation(AppDependencies.ANDROID_PAGING)
    ...
    implementation(AppDependencies.ANDROID_LIFECYCLE)
    implementation(AppDependencies.ANDROID_NAVIGATION_FRAGMENT)
    implementation(AppDependencies.ANDROID_NAVIGATION_UI)
    ...
    implementation(AppDependencies.OKHTTP3_INTERCEPTOR)
